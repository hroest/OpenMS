...
cdef extern from "<OpenMS/FORMAT/HANDLERS/IndexedMzMLDecoder.h>" namespace "OpenMS":
    ...
    cdef cppclass Internal_IndexedMzMLDecoder "OpenMS::IndexedMzMLDecoder":

        Internal_IndexedMzMLDecoder() nogil except +
        Internal_IndexedMzMLDecoder(Internal_IndexedMzMLDecoder) nogil except +
